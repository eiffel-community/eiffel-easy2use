...
export EIFFEL2_JENKINS_PLUGIN_VERSION=1.0.7
...
export EIFFEL2_JENKINS_IMAGE_TAG=${EIFFEL2_JENKINS_IMAGE_TAG_NAME}:${EIFFEL2_JENKINS_IMAGE_BUILD_VERSION}
export EIFFEL2_JENKINS_FEM_IMAGE_TAG=${ERICSSON_INTERNAL_SELI_DOCKER_REGISTRY}/${EIFFEL2_JENKINS_FEM_IMAGE_TAG_NAME}:${EIFFEL2_JENKINS_PLUGIN_VERSION}
export EIFFEL2_NEXUS_IMAGE_TAG=${EIFFEL2_NEXUS_IMAGE_TAG_NAME}:${EIFFEL2_NEXUS_VERSION}
