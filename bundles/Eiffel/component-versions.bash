...
export EIFFEL_EI_BACKEND_VERSION=1.0.2
export EIFFEL_EI_FRONTEND_VERSION=1.0.3
export EIFFEL_VICI_VERSION=0.0.1
export EIFFEL_DUMMY_ER_VERSION=latest
export EIFFEL_ER_VERSION=0.0.67
export EIFFEL_REMREM_GENERATE_VERSION=1.0.0
export EIFFEL_REMREM_PUBLISH_VERSION=1.0.0
export EIFFEL_JENKINS_IMAGE_BUILD_VERSION=2.150.2
export EIFFEL_JENKINS_PLUGIN_VERSION=1.0.7
...
export EIFFEL_JENKINS_IMAGE_TAG=${EIFFEL_JENKINS_IMAGE_TAG_NAME}:${EIFFEL_JENKINS_IMAGE_BUILD_VERSION}
export EIFFEL_JENKINS_FEM_IMAGE_TAG=${ERICSSON_INTERNAL_SELI_DOCKER_REGISTRY}/${EIFFEL_JENKINS_FEM_IMAGE_TAG_NAME}:${EIFFEL_JENKINS_PLUGIN_VERSION}
export EIFFEL_NEXUS_IMAGE_TAG=${EIFFEL_NEXUS_IMAGE_TAG_NAME}:${EIFFEL_NEXUS_VERSION}
