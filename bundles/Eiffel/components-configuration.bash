...
# K8S format
export K8S_CONFIG_EIFFEL_JENKINS_FEM="JAVA_OPTS=\"-Djenkins.install.runSetupWizard=false\"
WAIT_HOSTS: '${EIFFEL_RABBITMQ}\:${EIFFEL_RABBITMQ_WEB_EXTERNAL_PORT}'"

# Docker format
#      - JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties"
export DOCKER_CONFIG_EIFFEL_JENKINS_FEM="JAVA_OPTS=\"-Djenkins.install.runSetupWizard=false\"
WAIT_MB_HOSTS=${EIFFEL_RABBITMQ}\:${EIFFEL_RABBITMQ_WEB_EXTERNAL_PORT}"

### Source Jenkins Job etc. configuations
source ${CURRENT_DIR}/jenkins-configuration.bash
